    ...
    <body class="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 min-h-screen flex items-center justify-center p-4">
        <div class="w-full max-w-sm fade-in">
            ...
            <div class="card card-hover p-8">
                ...
                <!-- Divider -->
                <div class="flex items-center mb-6 slide-up" style="animation-delay: 0.2s;">
                ...
                <!-- Login Form -->
                <form method="POST" action="{{ route('login') }}" class="space-y-4 slide-up" style="animation-delay: 0.3s;">
                    @csrf
                    ...
                    <div class="flex items-center justify-between mt-4 slide-up" style="animation-delay: 0.4s;">
                    ...
                    <button 
                        type="submit" 
                        class="btn-primary w-full mt-6 slide-up" style="animation-delay: 0.5s;"
                    >
                        Entrar
                    </button>
                </form>
