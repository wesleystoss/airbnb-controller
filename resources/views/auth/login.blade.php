    ...
    <body class="bg-[#FDFDFC] text-[#1b1b18] flex p-6 lg:p-8 items-center justify-center min-h-screen">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] rounded-lg p-6">
                <a href="#" onclick="handleGoogleLogin(event)" class="w-full flex items-center justify-center gap-2 mb-4 px-4 py-2 rounded bg-white border border-[#e3e3e0] text-[#1b1b18] font-medium shadow hover:bg-gray-50 transition">
